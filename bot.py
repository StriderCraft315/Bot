...
DISCORD_TOKEN = os.getenv('DISCORD_TOKEN', 'MTQzODg1NTU1NzU2MDc5NTE4Nw.GBcm66.wvnPkBJecdpZg0lZhK_8LGcNXwGM9twlQBq7pA')
BOT_NAME = os.getenv('BOT_NAME', 'FluidNodes')
PREFIX = os.getenv('PREFIX', '!')
YOUR_SERVER_IP = os.getenv('YOUR_SERVER_IP', '45.41.206.9')
MAIN_ADMIN_ID = int(os.getenv('MAIN_ADMIN_ID', '1116270181191262299'))
